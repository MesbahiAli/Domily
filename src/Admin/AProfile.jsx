...
const AProfile = () => {
    ...
    if (!user) {
        return <div className="text-center text-orange-500 mt-20">Chargement...</div>;
    }
        ...
        <>
            ...
            <div className="flex pt-28 pb-6 items-center bg-gray-50 justify-center">
                <div className="bg-white text-orange-500 rounded-lg flex flex-col items-center p-6 shadow-lg w-full max-w-lg">
                    <img src={Prof} alt="Profile" className='h-72 w-72' />
                    <h1 className='text-4xl mb-3 font-bold text-center'>{user.nom} <br /> {user.prenom}</h1>
                    ...
                    <div className='flex flex-row text-sm font-bold justify-center items-center mt-3'>
                        <Link to="/editaprofile" className='text-sm font-semibold text-orange-600'>Modifier mon profil</Link>
