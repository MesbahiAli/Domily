            ...
            <div className="flex w-full pt-24 pb-6 items-center bg-gray-50 justify-center">
                <div className=" bg-white text-white rounded-lg items-center p-4 shadow-lg w-2/3">
                    ...
                    <div className='flex flex-col items-center justify-center bg-orange-500 rounded-lg pb-3'>
                        ...
                        <div>
                            <h1 className='text-4xl font-bold text-center mb-2 tracking-wider'>Anas El Ouarti</h1>
                    ...
                    <div className='col-span-2 text-orange-600 p-4 w-full items-start'>
                        ...
                        <p class="ms-1 text-sm font-medium text-gray-500 dark:text-gray-400 mb-6">16</p>
                        ...
                        <button onClick={() => setOpenModal(true)} type="submit" class="focus:outline-none w-full text-white bg-orange-500 hover:bg-orange-600 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-md px-5 py-2.5 dark:focus:ring-yellow-900">Reserver</button>
