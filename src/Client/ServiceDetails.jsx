...
<hr />
                        ...
                        <button type="submit" class="focus:outline-none w-full text-white bg-orange-500 hover:bg-orange-600 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-md px-5 py-2.5 dark:focus:ring-yellow-900">Reserver</button>
