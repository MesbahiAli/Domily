            ...
            <div className="flex w-full pt-28 pb-6 items-center bg-gray-50 justify-center">
                <div className="grid grid-cols-3 bg-white text-white rounded-lg items-center p-4 shadow-lg w-2/3">
                    ...
                    <div className='col-span-2 text-orange-600 p-4 w-full items-start'>
                        <h2 className='font-bold text-2xl mb-3'>A propos</h2>
                        ...
                        <p class="ms-1 text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">3</p>

                        <h2 className='font-bold text-2xl mb-3'>Nombre d'employés</h2>
                        <p class="ms-1 text-sm font-medium text-gray-500 dark:text-gray-400 mb-6">15</p>
                        ...
                        <div className='flex flex-row items-center justify-center'>
                            ...
                            <div className='flex flex-row m-3'>
                                ...
                                <p className='font-semibold'>beautycenter.ma</p>
                            </div>
                        </div>
                        ...
                        <div className='flex flex-row text-sm font-bold justify-center items-center mt-3'>
                            <Link to="/editeprofile" className='text-sm font-semibold text-orange-600'>Modifier le profile</Link>
