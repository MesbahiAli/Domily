                    ...
                    {services.map((service) => (
                        <Card key={service.id} className="max-w-sm">
                            ...
                            <div className="flex flex-row items-center justify-center">
                                <Link to={`/Eeditservice/${service.id}`} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 dark:bg-blue-600 dark:hover:bg-blue-700">
                                    Modifier
                                </Link>
                                <button
                                    type="button"
