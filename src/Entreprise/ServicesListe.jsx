                    ...
                    <div className="grid grid-cols-3 gap-4">
                        ...
                        <Card className="max-w-sm">
                            ...
                            <div className="flex flex-row items-center justify-center">
                                <Link to="/editservices" class="text-white bg-blue-700 hover:bg-blue-800 hover:text-white focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Modifier</Link>
                        ...
                        <Link to="/createservice" className="bg-slate-50 rounded-lg shadow-md border flex hover:bg-white text-8xl items-center justify-center text-gray-600 hover:text-orange-500">
                            +
                        </Link>
                    </div>
